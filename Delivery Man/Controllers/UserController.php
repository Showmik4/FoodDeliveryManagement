...
//----------------------------------------------------------------------------------------
    ...
    //do validations
    //if no error
    $rs = updateProfile($_POST["username"],$_POST["gender"],$_POST["email"],$_POST["address"],$_POST["id"]);
    if($rs === true){
...
//---------------------------------------------------
    ...
    function updateProfile($name,$gender,$email,$address,$id){
        $query = "update users set username='$name',gender='$gender',email='$email',address='$address' where id = '$id'";
		return execute($query);
    }
